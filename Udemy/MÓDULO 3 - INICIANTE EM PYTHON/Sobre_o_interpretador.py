...
--help (mostra oq pode fazer)
python mod.py (executa o mod)
python -u (unbuffered) (fala pra não salvar no buffer, memoria pra separar uma coisinha na memória)
python -m mod (lib mod como script) -m nome_biblioteca nome_que_você_quer_dar
