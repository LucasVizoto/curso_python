...
# O CSV é um dos formatos mais comuns de dados tabulares, e é amplamente
    # utilizado em diversas aplicações e softwares, como planilhas eletrônicas,
    # relatórios, e sistemas de gerenciamento de dados.
...
# experimente fazendo o upload do arquivo "aula1.csv" para o google shets
