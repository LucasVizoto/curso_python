...
# Reutilizando o código da aula anterior
...
for root, dirs, files in os.walk(caminho):
    ...
    for file_ in files:
        ...
        # faz basicamente a mesma coisa, mas com stat, você consegue buscar muito mais
        # informações sobre o arquivo

        print('  ', another_counter, 'FILE: ', file_, formata_tamanho(tamanho))